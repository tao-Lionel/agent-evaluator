...
def generate_html(results: list[dict], source_path: str, lang: str = "en", analysis: str = "") -> str:
    ...
    # Extract analysis from results if embedded, and filter it out
    if not analysis:
        for r in results:
            if "_analysis" in r:
                analysis = r["_analysis"]
                break
    results = [r for r in results if "_analysis" not in r]
...
def _render_task_card(result: dict, eval_names: list[str], t: dict) -> str:
    ...
    <div class="task-card {status_class}">
      <div class="task-header">
        ...
        <span class="task-meta">{steps} {t['steps']} &middot; {escape(terminated)}</span>
